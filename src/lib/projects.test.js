...
const { getProject, getIterations, findIteration } =
...
describe("getProject", () => {
  ...
  it("returns project for organization (isOrg: true)", async () => {
    ...
    expect(core.info).toHaveBeenCalledWith(
      "Found project: Test Project (https://github.com/orgs/test-org/projects/1)",
    );
  });
  ...
  it("returns null when project not found", async () => {
    ...
    expect(core.warning).toHaveBeenCalledWith(
      "Project #999 not found for test-org",
    );
  });
...
describe("getIterations", () => {
  ...
  it("returns empty array when no iteration field", async () => {
    ...
    expect(result).toEqual([]);
    expect(core.warning).toHaveBeenCalledWith(
      "No iteration field found in project",
    );
  });
...
describe("findIteration", () => {
  ...
  it("returns null when iteration not found", async () => {
    ...
    expect(result).toBeNull();
    expect(core.warning).toHaveBeenCalledWith(
      'Iteration "Sprint 99" not found in project #1',
    );
  });
