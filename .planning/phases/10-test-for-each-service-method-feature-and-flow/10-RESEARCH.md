...
| Colocated tests   | **tests** directories | More overhead for this project size (23 modules)                               |
...
| **tests** directories     | Colocated .test.js        | 2024+ trend  | Easier maintenance for small-medium projects    |
...
- [Colocation of Tests: A Cross-Language Perspective](https://itsmariodias.medium.com/colocation-of-tests-a-cross-language-perspective-982e75c872d8) - Colocated vs **tests** tradeoffs
