...
8. "configures git identity for commits" - configureGitIdentity is called with bot identity
   </action>
...
10. "extracts context from GitHub action inputs" - core.getInput called for issue-number, repo-owner, repo-name, comment-body
    </action>
